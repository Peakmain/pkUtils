...
#include "../utils/CalendarUtils.cpp"
...
JNICALL
Java_com_peakmain_utils_calendar_CalendarUtils_nativeGetCurrentDateModel(JNIEnv *env,
        jclass /* this */) {

    CalendarUtils calendarUtils;
    auto cppModel = calendarUtils.getCurrentDateModel();

    jclass modelClass = env->FindClass("com/peakmain/utils/calendar/model/CalendarModel");
    if (modelClass == nullptr)return nullptr;
    jmethodID constructor = env->GetMethodID(modelClass, "<init>", "(IIII)V");
    if (constructor == nullptr)return nullptr;
    return env->NewObject(modelClass, constructor, cppModel.year, cppModel.month, cppModel.weekDay, cppModel.day);
}